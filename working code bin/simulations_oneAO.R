...
#y[15,i]=y[15,i]+sqrt(ss$H)*7
 ...
 # y_m[70:90] = y_m[70:90] + min(y_m)+0.15*mean(y_m)-y_m[70:90]*0.12
  ...
  out.bsc[[i]]=isat_my(y_m, t.pval=1/T, model.ssmod = "llm+seas",turbo=TRUE,
                       iis=TRUE, sis=FALSE,vcov.type = "ordinary",info.method = 'aic', gr.kfs ="numerical", 
                       optim.kfs = list(lower = 0, upper = Inf, hessian = TRUE))
 # plot(out.bsc[[i]])
 out.bsc.eps[[i]]=isat(out.bsc[[i]]$pure$std.eps,sis=FALSE,iis=TRUE)
 plot.my4(out.bsc.eps[[i]])
 # out.bsc.eta[[i]]=isat(out.bsc[[i]]$pure$std.eta,sis=F,iis=T)#for the level
#  plot(out.bsc.eta[[i]])
#  end_time <- Sys.time()
#  print(end_time - start_time)
  end_time <- Sys.time()
  print(end_time - start_time)
  final.time[i]=round(((end_time - start_time)*60),2)
...
confusion.iis.AO(out.bsc.eps,vec.outlier1=c(1.371429e+14))
...
y= datagen.outlier(n = T, model = list(Z = ss$Z, T = ss$T, H = ss$H, Q = ss$Q, a0 = ss$a0), 
                       n0 = 70, old.version = TRUE,
                       AOplus=c(50),AOplusmag=15, AOminus=c(40),AOminusmag=0,
                       LSplus=c(50),LSplusmag=0,
                       TCminus=c(10), TCminusmag=0,SAOminus=c(70), SAOminusmag=0
)$data
set.seed(123)
y.without=datagen.outlier(n = T, model = list(Z = ss$Z, T = ss$T, H = ss$H, Q = ss$Q, a0 = ss$a0), 
                          n0 = 70, old.version = TRUE,
                          AOplus=c(50),AOplusmag=0, AOminus=c(40),AOminusmag=0,
                          LSplus=c(50),LSplusmag=0,
                          TCminus=c(10), TCminusmag=0,SAOminus=c(70), SAOminusmag=0
)$data
#y[15,i]=y[15,i]+sqrt(ss$H)*7
#y=ts(y,frequency =7) #
plot(y.without,col="blue",ylab="", cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5)
lines(y, pch=22, lty=2)
legend(1,90, legend=c("Original time series", "Time series with outliers"),
      col=c("blue","black"), lty=1:2, cex=2)
...
#y[15,i]=y[15,i]+sqrt(ss$H)*7
#y=ts(y,frequency =7) #
plot(y.without,col="blue",ylab="",ylim=c(min(y)-2,max(y)+0), cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5)
lines(y, pch=22, lty=2)
legend(1,125, legend=c("Original time series", "Time series with outliers"),
       col=c("blue","black"), lty=1:2, cex=2)
...
y= datagen.outlier(n = T, model = list(Z = ss$Z, T = ss$T, H = ss$H, Q = ss$Q, a0 = ss$a0), 
                   ...
                   AOplus=c(50),AOplusmag=0, AOminus=c(40),AOminusmag=0,
                   LSplus=c(50),LSplusmag=0,
                   TCminus=c(10), TCminusmag=60,SAOminus=c(70), SAOminusmag=0
)$data
set.seed(123)
y.without=datagen.outlier(n = T, model = list(Z = ss$Z, T = ss$T, H = ss$H, Q = ss$Q, a0 = ss$a0), 
                          n0 = 70, old.version = TRUE,
...
#y[15,i]=y[15,i]+sqrt(ss$H)*7
#y=ts(y,frequency =7) #
plot(y.without,col="blue",ylab="",ylim=c(min(y)-2,max(y.without)+0), cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5)
lines(y, pch=22, lty=2)
legend(1,90, legend=c("Original time series", "Time series with outliers"),
       col=c("blue","black"), lty=1:2, cex=2)
...
y= datagen.outlier(n = T, model = list(Z = ss$Z, T = ss$T, H = ss$H, Q = ss$Q, a0 = ss$a0), 
                   ...
                   AOplus=c(50),AOplusmag=0, AOminus=c(40),AOminusmag=0,
                   LSplus=c(50),LSplusmag=0,
                   TCminus=c(10), TCminusmag=0,SAOminus=c(50), SAOminusmag=20
)$data
set.seed(123)
y.without=datagen.outlier(n = T, model = list(Z = ss$Z, T = ss$T, H = ss$H, Q = ss$Q, a0 = ss$a0), 
                          n0 = 70, old.version = TRUE,
...
#y[15,i]=y[15,i]+sqrt(ss$H)*7
#y=ts(y,frequency =7) #
plot(y.without,col="blue",ylab="",ylim=c(min(y)-2,max(y)),cex.lab=1.5,cex.axis=4, cex.main=1.5, cex.sub=1.5)
lines(y, pch=22, lty=2)
legend(1,100, legend=c("Original time series", "Time series with outliers"),
       col=c("blue","black"), lty=1:2, cex=2)
